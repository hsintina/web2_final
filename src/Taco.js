...
function Taco() {
  const [users, setUsers] = useState([
    { title:"Tacosan" ,subtitle:"A sausage, one of the common dish in japanese lunchbox, disguises himself as an octopus, with some rice on his feet.", picture1:styleframe1, picture2:styleframe2},
